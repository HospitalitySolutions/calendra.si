...
class PreviewDataFactory {
    ...
    private val tenant = TenantSummary(
        ...
        companyAddress = "Dunajska cesta 1",
        tenantType = "gym",
    ...
    private val yogaTenant = TenantSummary(
        ...
        publicCity = "Celje",
        companyAddress = "Mariborska cesta 5",
        tenantType = "therapy",
    ...
    fun searchTenants(query: String, tenantType: String? = null): List<TenantSummary> = listOf(
        tenant,
        yogaTenant,
        TenantSummary(
        ...
        (query.isBlank() || tenant.companyName.contains(query, ignoreCase = true)) &&
            (tenantType.isNullOrBlank() || tenant.tenantType == tenantType)
    }
...
,
            WalletOrder(
                ...
                invoiceOrderId = "NOR-101-24",
                status = "REFUNDED",
                paymentMethodType = "CARD",
                totalGross = -24.0,
                currency = "EUR",
                paidAt = "2026-04-17T10:00:00Z",
                createdAt = "2026-04-17T10:00:00Z",
                referenceCode = "REFUND-ORD-2026-00017",
                productName = "Refund · Yoga Flow",
                productType = "CLASS_TICKET",
                billPaymentStatus = "PAID"
            )
        )
    ...
    fun rescheduleBooking(companyId: String, bookingId: String, newSlotId: String): BookingActionResult =
        BookingActionResult(
            bookingId = bookingId,
            bookingStatus = "CONFIRMED",
    ...
    fun cancelBooking(companyId: String, bookingId: String): BookingActionResult =
        BookingActionResult(
            bookingId = bookingId,
