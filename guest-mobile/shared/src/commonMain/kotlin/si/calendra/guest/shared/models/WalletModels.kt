...
data class WalletOrder(
    val orderId: String,
    val invoiceOrderId: String? = null,
    val status: String,
    ...
    /** Company display/legal name for pending transfer instructions. */
    val paymentCompanyName: String? = null,
    /** Company address for pending transfer instructions. */
    val paymentCompanyAddress: String? = null,
    /** Company IBAN for pending transfer instructions. */
    val paymentIban: String? = null
)
