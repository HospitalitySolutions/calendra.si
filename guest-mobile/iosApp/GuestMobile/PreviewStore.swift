...
final class PreviewStore: ObservableObject {
    ...
    @Published var linkedTenants: [TenantModel] = [
        ...
        TenantModel(id: "tenant-yoga", name: "Blue River Yoga", description: "Studio classes and private sessions", city: "Celje", phone: "+38640111333", status: "ACTIVE", companyAddress: "Mariborska cesta 5", requireOnlinePayment: true)
    ]
    ...
    private struct TenantProfilePreference {
        ...
        var invoiceSettings: GuestInvoiceSettingsModel
    }

    private var tenantProfilePreferences: [String: TenantProfilePreference] = [
        "tenant-northside": TenantProfilePreference(
            linkedCompanyId: "101",
            batchPaymentEnabled: true,
            notifyMessagesEnabled: true,
            notifyRemindersEnabled: true,
            invoiceSettings: GuestInvoiceSettingsModel(
                recipientType: "PERSON",
                personAddressLine: "Dunajska cesta 1",
                personPostalCode: "1000",
                personCity: "Ljubljana"
            )
        ),
        "tenant-yoga": TenantProfilePreference(
            linkedCompanyId: nil,
            ...
            invoiceSettings: GuestInvoiceSettingsModel(
                ...
                companyName: "Blue River Yoga d.o.o.",
                companyAddressLine: "Mariborska cesta 5",
    ...
    func profileSettings(companyId: String?) -> GuestProfileSettingsModel {
        ...
        let preference = tenantProfilePreferences[tenant?.id ?? ""] ?? TenantProfilePreference(
            linkedCompanyId: nil,
            batchPaymentEnabled: false,
            notifyMessagesEnabled: true,
            notifyRemindersEnabled: true,
        ...
        return GuestProfileSettingsModel(
            ...
            invoiceSettings: preference.invoiceSettings
        )
    }
    ...
    func updateProfileSettings(_ payload: UpdateGuestProfileSettingsPayload) -> GuestProfileSettingsModel {
        ...
        var pref = tenantProfilePreferences[companyId] ?? TenantProfilePreference(
            linkedCompanyId: nil,
            batchPaymentEnabled: false,
            notifyMessagesEnabled: true,
            notifyRemindersEnabled: true,
        ...
        if let invoiceRecipientType = payload.invoiceRecipientType {
            pref.invoiceSettings = GuestInvoiceSettingsModel(
                recipientType: invoiceRecipientType,
                personAddressLine: payload.invoicePersonAddressLine,
                personPostalCode: payload.invoicePersonPostalCode,
                personCity: payload.invoicePersonCity,
                companyName: payload.invoiceCompanyName,
                companyAddressLine: payload.invoiceCompanyAddressLine,
                companyPostalCode: payload.invoiceCompanyPostalCode,
                companyCity: payload.invoiceCompanyCity,
                companyVatId: payload.invoiceCompanyVatId
            )
        }
    ...
    func dashboard(for companyId: String) -> TenantDashboardModel {
        ...
        return TenantDashboardModel(
            ...
            orders: [
                ...
                OrderModel(id: "order-paid-a", invoiceOrderId: "NOR-101-21", status: "PAID", paymentMethod: "CARD", totalGross: 59.0, currency: "EUR", paidAt: "2026-04-15T10:00:00Z", createdAt: "2026-04-15T09:58:00Z", referenceCode: "ORD-2026-00021", productName: "Monthly Membership", productType: "MEMBERSHIP", billPaymentStatus: "PAID", paymentCompanyName: nil, paymentCompanyAddress: nil, paymentIban: nil),
                OrderModel(id: "order-paid-b", invoiceOrderId: "NOR-101-19", status: "PAID", paymentMethod: "PAYPAL", totalGross: 45.0, currency: "EUR", paidAt: "2026-04-12T14:22:00Z", createdAt: "2026-04-12T14:21:00Z", referenceCode: "ORD-2026-00019", productName: "Personal Training", productType: "CLASS_TICKET", billPaymentStatus: "PAID", paymentCompanyName: nil, paymentCompanyAddress: nil, paymentIban: nil)
            ],
            notifications: [
