...
struct GuestInvoiceSettingsModel: Codable, Hashable {
    let recipientType: String
    let personAddressLine: String?
    let personPostalCode: String?
    let personCity: String?
    let companyName: String?
    let companyAddressLine: String?
    let companyPostalCode: String?
    let companyCity: String?
    let companyVatId: String?

    init(
        recipientType: String = "PERSON",
        personAddressLine: String? = nil,
        personPostalCode: String? = nil,
        personCity: String? = nil,
        companyName: String? = nil,
        companyAddressLine: String? = nil,
        companyPostalCode: String? = nil,
        companyCity: String? = nil,
        companyVatId: String? = nil
    ) {
        self.recipientType = recipientType
        self.personAddressLine = personAddressLine
        self.personPostalCode = personPostalCode
        self.personCity = personCity
        self.companyName = companyName
        self.companyAddressLine = companyAddressLine
        self.companyPostalCode = companyPostalCode
        self.companyCity = companyCity
        self.companyVatId = companyVatId
    }
}
...
struct UpdateGuestProfileSettingsPayload: Codable {
    ...
    let invoicePersonCity: String?
    let invoiceCompanyName: String?
    let invoiceCompanyAddressLine: String?
    let invoiceCompanyPostalCode: String?
    let invoiceCompanyCity: String?
    let invoiceCompanyVatId: String?
    ...
    init(
        ...
        invoicePersonCity: String? = nil,
        invoiceCompanyName: String? = nil,
        invoiceCompanyAddressLine: String? = nil,
        invoiceCompanyPostalCode: String? = nil,
        invoiceCompanyCity: String? = nil,
        invoiceCompanyVatId: String? = nil
    ) {
        ...
        self.invoicePersonCity = invoicePersonCity
        self.invoiceCompanyName = invoiceCompanyName
        self.invoiceCompanyAddressLine = invoiceCompanyAddressLine
        self.invoiceCompanyPostalCode = invoiceCompanyPostalCode
        self.invoiceCompanyCity = invoiceCompanyCity
        self.invoiceCompanyVatId = invoiceCompanyVatId
    }
}
...
struct OrderModel: Identifiable, Codable, Hashable {
    ...
    /// Populated for pending bank transfer (wallet API).
    let paymentCompanyName: String?
    let paymentCompanyAddress: String?
...
struct SignupStartPayload: Codable {
    let email: String
    let password: String
    let firstName: String
    let lastName: String
...
struct SignupChallengeModel: Codable {
    let challengeId: String
    let email: String
    let expiresAt: String
}

struct VerifySignupCodePayload: Codable {
    let challengeId: String
    let code: String
}

struct ResendSignupCodePayload: Codable {
    let challengeId: String
}
