              ...
              <div class="payment-block">
                ...
                ` : hasAnyPaymentMethod ? `
                  <div class="payment-grid">
                    ${allowed.card ? `
                      ${cardVariant('card', t.paymentMethodCard, t.paymentMethodCardSubtitle, this.uiIcon('card'))}
                      ${cardVariant('apple-pay', t.paymentMethodApplePay, t.paymentMethodApplePaySubtitle, '<span class="apple-pay-mark"></span>')}
                      ${cardVariant('google-pay', t.paymentMethodGooglePay, t.paymentMethodGooglePaySubtitle, '<span class="google-pay-mark">G</span>')}
                    ` : ''}
                    ${!allowed.card && allowed.bankTransfer ? methodTile('BANK_TRANSFER', t.paymentMethodBank, t.paymentMethodBankSubtitle, this.paymentMethodLogos('BANK_TRANSFER')) : ''}
                    ${!allowed.card && allowed.paypal ? methodTile('PAYPAL', t.paymentMethodPaypal, t.paymentMethodPaypalSubtitle, this.paymentMethodLogos('PAYPAL')) : ''}
                    ${!allowed.card && allowed.giftCard ? methodTile('GIFT_CARD', t.paymentMethodGiftCard, t.paymentMethodGiftCardSubtitle, this.paymentMethodLogos('GIFT_CARD')) : ''}
                  </div>
