...
public class FiscalSettingsService {
    ...
    private FiscalSettings forLegalEntity(
        ...
        return new FiscalSettings(
                ...
                firstNonBlank(issuer.getFiscalCadastralNumber(), get(companyId, SettingKey.FISCAL_CADASTRAL_NUMBER, "")),
                firstNonBlank(issuer.getFiscalBuildingNumber(), get(companyId, SettingKey.FISCAL_BUILDING_NUMBER, "")),
                firstNonBlank(issuer.getFiscalBuildingSectionNumber(), get(companyId, SettingKey.FISCAL_BUILDING_SECTION_NUMBER, "")),
                firstNonBlank(issuer.getFiscalHouseNumber(), get(companyId, SettingKey.FISCAL_HOUSE_NUMBER, "")),
                firstNonBlank(issuer.getFiscalHouseNumberAdditional(), get(companyId, SettingKey.FISCAL_HOUSE_NUMBER_ADDITIONAL, "")),
