...
public class SecurityCenterController {
    ...
    public SecurityCenterController(SecurityCenterService securityCenterService, JwtService jwtService) {
    ...
    private String currentSessionId(HttpServletRequest request) {
        ...
        try {
            return jwtService.extractSessionId(authHeader.substring(7));
        } catch (Exception ex) {
            return null;
        }
    }
