...
final class GuestPreviewService {
    ...
    static GuestPreviewDtos.HomeResponse home(String companyId) {
        ...
        return new GuestPreviewDtos.HomeResponse(
                ...
                "tenant-yoga".equals(companyId)
                        ? List.of(
                                new GuestPreviewDtos.EntitlementResponse("ent-2", "Yoga 10 Pack", "PACK", "ENT-YOGA10PK01", 7, 0, 10, "2026-06-11T00:00:00Z", 60, "ACTIVE", "YP-120-001", 120.0, null, "EUR")
                        )
                        : List.of(
                                new GuestPreviewDtos.EntitlementResponse("ent-1", "Core Mix 8-vstopov", "PACK", "ENT-COREMIX801", 6, 0, 8, "2026-06-01T00:00:00Z", 90, "ACTIVE", "CM8-425-001", 425.0, null, "EUR"),
                                new GuestPreviewDtos.EntitlementResponse("ent-3", "Monthly Gym", "MEMBERSHIP", "ENT-MONTHLYG01", null, 12, null, "2026-05-01T00:00:00Z", 30, "ACTIVE", "MG-59-001", 59.0, null, "EUR")
                        ),
                List.of(
    ...
    static GuestPreviewDtos.WalletResponse wallet(String companyId) {
        return new GuestPreviewDtos.WalletResponse(
                ...
                List.of(
                        new GuestPreviewDtos.WalletOrderResponse(
                                "order-paid-1",
                                "PAID",
                                "CARD",
                                59.0,
                        ...
                        new GuestPreviewDtos.WalletOrderResponse(
                                ...
                                "EUR",
                                null,
                                "2026-04-14T18:22:00Z",
                                "ORD-2026-00014",
                                "5 Session Pack",
                                "PACK",
                                "payment_pending",
                                "Northside Fitness",
                                "Litijska cesta 52, 1000 Ljubljana",
                                "SI56 1910 0000 1234 56"
                        )
                )
        );
    }
