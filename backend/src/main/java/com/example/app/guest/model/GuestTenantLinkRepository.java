...
public interface GuestTenantLinkRepository extends JpaRepository<GuestTenantLink, Long> {
    ...
    Optional<GuestTenantLink> findFirstByCompanyIdAndClientIdAndStatusOrderByUpdatedAtDesc(Long companyId, Long clientId, GuestTenantLinkStatus status);
    List<GuestTenantLink> findAllByCompanyIdAndClientIdAndStatusOrderByUpdatedAtDesc(Long companyId, Long clientId, GuestTenantLinkStatus status);
