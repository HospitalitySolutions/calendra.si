...
public enum SettingKey {
    ...
    /** Shows tenant custom email sender/domain controls in Configuration -> Notifications. */
    ...
    COMPANY_POSTAL_CODE,
    COMPANY_CITY,
    COMPANY_PHYSICAL_ADDRESS_SAME_AS_COMPANY,
    COMPANY_PHYSICAL_ADDRESS,
    COMPANY_PHYSICAL_POSTAL_CODE,
    COMPANY_PHYSICAL_CITY,
    COMPANY_PHYSICAL_COUNTRY,
    COMPANY_VAT_ID,
    COMPANY_IBAN,
    COMPANY_BIC,
    COMPANY_EMAIL,
