...
public class GoogleOAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private String buildRegisterAccountFinishVerifyUrl(String returnSearch, String verifyEmail, String challengeId) {
        String url = buildRegisterAccountFinishVerifyUrl(returnSearch, verifyEmail);
        if (challengeId == null || challengeId.isBlank()) {
            return url;
        }
        return url + "&challengeId=" + URLEncoder.encode(challengeId, StandardCharsets.UTF_8);
    }
