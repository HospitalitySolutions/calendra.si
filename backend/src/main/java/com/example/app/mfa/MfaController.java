...
public class MfaController {
    ...
    public MfaController(WebAuthnService webAuthnService, JwtService jwtService, SecurityCenterService securityCenterService, AuthCookieService authCookieService) {
    ...
    public ResponseEntity<?> verifyAssertion(@RequestBody VerifyAssertionRequest request, HttpServletRequest httpRequest, HttpServletResponse httpResponse) {
        try {
            User user = webAuthnService.finishLoginWithAssertion(request.pendingToken(), request.credentialJson());
            return ResponseEntity.ok(authResponse(user, httpRequest, httpResponse));
        } catch (Exception ex) {
    ...
    public ResponseEntity<?> verifyRecoveryCode(@RequestBody VerifyRecoveryCodeRequest request, HttpServletRequest httpRequest, HttpServletResponse httpResponse) {
        try {
    ...
    private Map<String, Object> authResponse(User user, HttpServletRequest request, HttpServletResponse response) {
