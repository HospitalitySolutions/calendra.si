...
export function CheckoutReturnPage() {
  ...
  if (!orderId) return <div className="commerce-result-page"><section className="commerce-result-card"><div className="commerce-result-mark commerce-result-mark--error"><CloseIcon size={28}/></div><h2>Manjka podatek o naročilu</h2><Link className="button button--primary" to="/denarnica">Odpri denarnico</Link></section></div>
