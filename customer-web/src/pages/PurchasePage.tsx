...
export function PurchasePage() {
  ...
  useEffect(() => {
    const methods = (catalogQuery.data?.acceptedPaymentMethods || []).filter(method => method !== 'PAYPAL')
