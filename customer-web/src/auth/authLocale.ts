...
export const authCopy = {
  sl: {
    ...
    googleSigningIn: 'Prijavljam z Google …',
    appleSigningIn: 'Prijavljam z Apple …',
    socialLoginError: 'Prijava ni uspela. Poskusite znova.',
    socialLoginUnavailable: 'Ta način prijave trenutno ni konfiguriran.',
  ...
  en: {
    ...
    socialLoginError: 'Sign-in failed. Please try again.',
    socialLoginUnavailable: 'This sign-in method is not configured yet.',
  ...
  sr: {
    ...
    googleSigningIn: 'Prijavljivanje putem Google …',
    appleSigningIn: 'Prijavljivanje putem Apple …',
    socialLoginError: 'Prijava nije uspela. Pokušajte ponovo.',
    socialLoginUnavailable: 'Ovaj način prijave trenutno nije podešen.',
