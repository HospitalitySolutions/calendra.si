...
export function ConfigurationWhatsAppSection({
  settings,
  setSettings,
  savingSettings,
  onSave,
    ...
    return (
      <Card className="settings-card">
        ...
        <p className="muted" style={{ marginBottom: 0 }}>
          WhatsApp is globally disabled by platform admin.
        </p>
      </Card>
    )
  }
...
export function ConfigurationViberSection({
  settings,
  setSettings,
  savingSettings,
  onSave,
  ...
  if (!globallyEnabled) {
    return (
      <Card className="settings-card">
        ...
        <p className="muted" style={{ marginBottom: 0 }}>
          Viber is globally disabled by platform admin.
        </p>
      </Card>
    )
  }
