...
export function ConsultantsPage({ selfService = false }: ConsultantsPageProps) {
  ...
  return (
    <div className="stack gap-lg">
      ...
      {showFormPanel && (
        <div className="modal-backdrop booking-side-panel-backdrop" onClick={dismissFormPanel}>
          <div className="modal large-modal booking-side-panel" onClick={(e) => e.stopPropagation()}>
            <div className="booking-side-panel-header">
              <PageHeader
                title={selfService ? t('myProfileTitle') : editing ? 'Edit consultant' : 'New consultant'}
                actions={
                  <button type="button" className="secondary booking-side-panel-close" onClick={dismissFormPanel} aria-label="Close">
                    ×
                  </button>
                }
              />
            ...
            <div className="consultant-panel-stack">
              ...
              <Field label={t('employeesFormPassword')} hint={editing || selfService ? t('employeesFormPasswordHintEdit') : undefined}>
                <input required={!editing && !selfService} type="password" value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} />
              </Field>
