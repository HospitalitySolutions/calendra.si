...
import {
  ...
  applyNotificationModuleAvailability,
...
} from "./configuration/companyProfiles";
import {
  DEFAULT_ACCOUNT_REGISTER_CATALOG,
  accountAddonKeysToCsv,
  accountPackageToRegisterPlanKey,
  accountPlanLabel,
  accountRegisterPlanRank,
  accountUsagePercent,
  normalizeAccountAddonKey,
  normalizeAccountRegisterCatalog,
  normalizeAccountRegisterPlanKey,
  parseAccountAddonKeyCsv,
...
import {
  ...
  defaultGuestAppSettings,
  defaultGuestBookingRules,
  defaultWebsiteBookingRules,
...
import {
  ...
  getModuleVisibilityRule,
  moduleVisibilityAllowed,
  modulesDraftToSettingsPatch,
  normalizeModuleVisibilityPackage,
  normalizeOptionalModuleConfigType,
  parseModuleVisibilityRules,
  serializeModuleVisibilityRules,
  type ModuleVisibilityRule,
  type ModuleVisibilityRuleKey,
  ...
  const modulesDesignGroups: ModulesDesignGroup[] = [
    {
      ...
      rows: [
        ...
        },
        {
          ...
          valueControl: (
            <span className="modules-design-inline-control modules-design-inline-control--with-suffix modules-design-inline-control--prominent-value modules-design-inline-control--numeric-unit">
              <input
                type="number"
                min="15"
                step="15"
  ...
  const getConfigTabLabel = useCallback(
    (tabId: Tab) => {
      ...
      if (tabId === "customFields")
        return locale === "sl" ? "Polja po meri" : "Custom fields";
