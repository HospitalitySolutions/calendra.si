...
export const CONSUMABLES_VIEW_PERMISSION = 'CONSUMABLES_VIEW'
export const CONSUMABLES_EDIT_PERMISSION = 'CONSUMABLES_EDIT'
export const CONSUMABLES_STOCK_ADJUST_PERMISSION = 'CONSUMABLES_STOCK_ADJUST'
export const CONSUMABLES_PROCUREMENT_PERMISSION = 'CONSUMABLES_PROCUREMENT'
export const CONSUMABLES_INVENTORY_PERMISSION = 'CONSUMABLES_INVENTORY'
export const CONSUMABLES_REPORTS_PERMISSION = 'CONSUMABLES_REPORTS'

export const CONSUMABLE_SPECIAL_PERMISSIONS = [
  CONSUMABLES_VIEW_PERMISSION,
  CONSUMABLES_EDIT_PERMISSION,
  CONSUMABLES_STOCK_ADJUST_PERMISSION,
  CONSUMABLES_PROCUREMENT_PERMISSION,
  CONSUMABLES_INVENTORY_PERMISSION,
  CONSUMABLES_REPORTS_PERMISSION,
] as const
...
export const ALL_EMPLOYEE_PERMISSIONS = [
  ...
  BILLING_OPEN_INVOICE_PERMISSION,
  BILLING_REFUND_PERMISSION,
  ...CONSUMABLE_SPECIAL_PERMISSIONS,
...
function enforceViewDependencies(values: Set<string>) {
  ...
  if (!values.has(CONSUMABLES_VIEW_PERMISSION)) {
    values.delete(CONSUMABLES_EDIT_PERMISSION)
    values.delete(CONSUMABLES_STOCK_ADJUST_PERMISSION)
    values.delete(CONSUMABLES_PROCUREMENT_PERMISSION)
    values.delete(CONSUMABLES_INVENTORY_PERMISSION)
    values.delete(CONSUMABLES_REPORTS_PERMISSION)
  }
}
