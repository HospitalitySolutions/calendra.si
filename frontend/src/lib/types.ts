...
export type SessionType = { id: number; name: string; description?: string; durationMinutes?: number; breakMinutes?: number; createdAt?: string; linkedServices?: TypeServiceLink[] }
...
export function normalizePaymentMethod(
  pm: { id: number; name: string; paymentType: PaymentType; fiscalized?: boolean; stripeEnabled?: boolean } | null | undefined,
): PaymentMethod | null {
  if (!pm) return null
  return {
    id: pm.id,
