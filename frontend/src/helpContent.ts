...
export const HELP_ENTRIES: HelpEntry[] = [
  ...
  {
    id: 'cfg-mod-multi-space',
    section: 'configuration',
    titleKey: 'configModulesMultipleSessionsPerSpaceLabel',
    tooltipKey: 'configModulesMultipleSessionsPerSpaceHelp',
  },
  {
    id: 'cfg-mod-multi-client',
    section: 'configuration',
    titleKey: 'configModulesMultipleClientsPerSessionLabel',
    tooltipKey: 'configModulesMultipleClientsPerSessionHelp',
  },
  {
    id: 'cfg-mod-groups',
    section: 'configuration',
    titleKey: 'configModulesGroupBookingLabel',
    tooltipKey: 'configModulesGroupBookingHelp',
  },
  {
    id: 'cal-availability',
    section: 'calendar',
